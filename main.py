...
def get_authenticated_service():
    if os.path.isfile("credentials.json"):
        ...
        credentials = Credentials(creds_data['token'])
...
def info_need_upload(file, title, desciption, category, tags):
    ...
    parser.add_argument('--description', help='Video description', default=desciption)
    parser.add_argument('--category', default=category)
    parser.add_argument('--tags', help='Video tags', default=tags)
...
if __name__ == '__main__':
    # info = info_need_upload("input.mp4", "tuyển tập phim việt nam hay nhất - lol channel", "là lá la", "22", "á,b,là")
    # print(info)
    os.environ['OAUTHLIB_INSECURE_TRANSPORT'] = '1'
    client = get_authenticated_service()
    media_file = "input.mp4"
    ...
    videos_insert(client,
                  {'snippet.categoryId': 22,
                   ...
                   'snippet.description': "tuyển tập phim việt nam hay nhất - lol channel",
                   'snippet.tags[]': "tag1,lá,là",
                   'snippet.title': "tuyển tập phim việt nam hay nhất - lol channel",
                   'status.embeddable': '',
                   'status.license': '',
